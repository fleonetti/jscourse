...
*/
var arr = [10, "fer", null, { a: 1 }, function () { }];
...
console.log(myFunction(arr)[1]); //fer // OU
myFunction()[1]; //fer
...
*/
var myarray2 = ["Ninja", 52.4, true, [1, 2, "Fernando"], { b: 2 }];
...
function book( bookName ) {
    ...
    //o book não foi passado? eu retorno allbooks, caso ao contrario ele me retorna o bookname.
